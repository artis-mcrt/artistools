...
#compdef at artistools makeartismodel makeartismodel1dslicefromcone plotartisdensity plotartisestimators plotartisinitialcomposition plotartislightcurve plotartislinefluxes plotartismacroatom plotartisnltepops plotartisnonthermal plotartisradfield plotartisspectrum plotartistransitions plotartisviewingangles
