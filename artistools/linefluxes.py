...
def make_flux_ratio_plot(args: argparse.Namespace) -> None:
    ...
    fig, axes = plt.subplots(
        ...
        ncols=1,
        sharey=False,
        figsize=(args.figscale * at.plottools.FIGWIDTH, args.figscale * at.plottools.FIGWIDTH * (0.25 + nrows * 0.4)),
    ...
    for modelindex, (modelpath, modellabel, modeltag) in enumerate(
        ...
        for tmid in times_days:
            ...
            fig, axis = plt.subplots(
                ...
                sharex=False,
                figsize=(
                    args.figscale * at.plottools.FIGWIDTH,
                    args.figscale * at.plottools.FIGWIDTH * (0.25 + nrows * 0.7),
                ),
